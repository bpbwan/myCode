...
import mtk.src.com.android.settings.DevelopmentSettings;
import mtk.src.com.android.settings.Settings.HeaderAdapter;
          ...
          //显示
            ...
            //备份和重置
                ...
                target.remove(header);
                    ...
                    //remove DivX by flyaudio
                   else if(id ==R.id.drm_divx_settings){
                        target.remove(i);
                   }
                    //remove DVD by flyaudio
                    else if(id ==R.id.dvd_settings){
                            target.remove(i);
                        }
