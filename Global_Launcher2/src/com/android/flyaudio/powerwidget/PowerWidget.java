...
public class PowerWidget extends FrameLayout {
    ...
    private static final String BUTTONS_DEFAULT = PowerButton.BUTTON_BRIGHTNESS
    			     ...
    			     + BUTTON_DELIMITER + PowerButton.BUTTON_MOBILEDATA
                             + BUTTON_DELIMITER + PowerButton.BUTTON_MEMORY
                             + BUTTON_DELIMITER + PowerButton.BUTTON_RESET
                             + BUTTON_DELIMITER + PowerButton.BUTTON_SETTINGS;
...
//                                        0.14f                                 // weight = 1
    ...
    private static final int LAYOUT_SCROLL_BUTTON_THRESHOLD = 7;
    ...
    static {
        ...
        sPossibleButtons.put(PowerButton.BUTTON_MEMORY, RecycleMemoryButton.class);
        sPossibleButtons.put(PowerButton.BUTTON_RESET, ResetButton.class);
...
//        updateVisibility();
    ...
    public void setupWidget() {
        ...
        String buttons = null /*Settings.System.getString(mContext.getContentResolver(), Settings.System.WIDGET_BUTTONS)*/;
        if (buttons == null) {
...
//            }
        ...
        Log.d(TAG," mBroadcastReceiver: " + (mBroadcastReceiver!=null));
        if(mBroadcastReceiver==null)
        	setupBroadcastReceiver();
    ...
    private void recreateButtonLayout() {
        ...
        mButtonLayout.setGravity(Gravity.CENTER_VERTICAL);

        for (String button : mButtonNames) {
            PowerButton pb = mButtons.get(button);
            if (pb != null) { 
            	Log.d(TAG,"  ====recreateButtonLayout+ ");
                View buttonView = Launcher.flyLauncher.getLayoutFromSkin(Launcher.skinContext, "power_widget_button");
...
//            updateScrollbar();
    ...
    private IntentFilter getMergedBroadcastIntentFilter() {
        ...
        Log.d(TAG,"PowerWidget getMergedBroadcastIntentFilter");
    ...
    private void updateButtonLayoutWidth() {
       ...
       // BUTTON_LAYOUT_PARAMS.width = mContext.getResources().getDisplayMetrics().widthPixels / LAYOUT_SCROLL_BUTTON_THRESHOLD;
    	BUTTON_LAYOUT_PARAMS.width=Launcher.flyLauncher.getIntegerFromSkin(Launcher.skinContext, "power_button_width")/LAYOUT_SCROLL_BUTTON_THRESHOLD;
        //BUTTON_LAYOUT_PARAMS.width = mContext.getResources().getInteger(R.integer.power_button_width)/ LAYOUT_SCROLL_BUTTON_THRESHOLD;
    }
...
//    }
    ...
    private class WidgetSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            Log.d(TAG," PowerWidget onChange..... uri = " + uri);
