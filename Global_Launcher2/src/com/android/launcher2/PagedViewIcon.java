...
public class PagedViewIcon extends TextView {
    ...
    public void applyFromApplicationInfo(ApplicationInfo info, boolean scaleUp,
		...
		//      int  textsize = (Launcher.flyLauncher.getColorFromSkin(
//              Launcher.skinContext, "apps_textview_size"));
		int  textColor = (Launcher.flyLauncher.getColorFromSkin(
				  Launcher.skinContext, "apps_textview_color"));

    	String  textsize =Launcher.flyLauncher.getStringFromSkin(Launcher.skinContext, "apps_textview_size");
