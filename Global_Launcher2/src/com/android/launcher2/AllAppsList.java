...
class AllAppsList {
    ...
    public void add(ApplicationInfo info) {
		...
		if(Launcher.FLYMODE && Launcher.isFlyApps(info.componentName.getClassName()))
			return;
    ...
    public void addPackage(Context context, String packageName) {
        ...
        if (matches.size() > 0) {
            for (ResolveInfo info : matches) {
                ApplicationInfo applicationInfo = new ApplicationInfo(context.getPackageManager(), info, mIconCache, null);
                add(applicationInfo,true);
            }
        }
    }
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (applicationInfo == null) {
                    //add(new ApplicationInfo(context.getPackageManager(), info, mIconCache, null));
                      add(new ApplicationInfo(context.getPackageManager(), info, mIconCache, null), true);
                } else {
