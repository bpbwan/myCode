...
public class TelescopicAnimation extends AnimationBase<TelescopicAnimation> {
	...
	int start,end;
   TelescopicTargetCallback mCallback;

	public interface TelescopicMode {
		public static final int IN = 0x01, OUT = 0x02, UDEF = 0x03;
	}
	
	public interface TelescopicTargetMode {
		public static final int WIDTH = 0x04, HEIGHT = 0x05;
	}



	public interface TelescopicTargetCallback {
      ...
      //  targetView.measure(widthSpec, heightSpec);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
				...
				if(mCallback != null)
					mCallback.TelescopicCallback(layoutParams.width, layoutParams.height);
	...
	public TelescopicAnimation setCallBacks(TelescopicTargetCallback callback){
		mCallback = callback;
		return this;
		}
